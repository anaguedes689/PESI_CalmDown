...
public class JacketActivity extends Activity {
    ...
    private JacketData jacketDevice;
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                ...
                case BioLib.MESSAGE_RTC:
                    ...
                    jacketDevice.setDateTimeRTC(DATETIME_RTC);
                ...
                case BioLib.MESSAGE_DATA_UPDATED:
                    ...
                    jacketDevice.setBatteryLevel(BATTERY_LEVEL);
                    textBAT.setText("BAT: " + BATTERY_LEVEL + " %");
                    PULSE = out.pulse;
                    jacketDevice.setPulse(PULSE);
                ...
                case BioLib.MESSAGE_ACC_UPDATED:
                    ...
                    jacketDevice.setDataACC(dataACC);
                ...
                case BioLib.MESSAGE_ECG_STREAM:
                    try
                    {
                        ...
                        ecg = (byte[][]) msg.obj;
                        jacketDevice.setEcg(ecg);
                        int nLeads = ecg.length;
                        nBytes = ecg[0].length;
                        jacketDevice.setnBytes(nBytes);
